...
* Fixed, only 10 locations were visible in the location dropdown when editing an event.
* Tweaked some name constants.


= 1.3.9 =

* Changed .handle to .epl_handle CSS rule name to eliminate conflict in WP admin.
* Fixed, when a time is not setup for an event, the times section will not be visible in the event list and confirmation page.
* Fixed, when a value is setup for dropdown, radio or checkbox fields in Form manager, it was not coming through to the exported file.
